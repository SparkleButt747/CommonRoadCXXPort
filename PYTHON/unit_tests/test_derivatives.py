...
class TestDerivatives(unittest.TestCase):
    ...
    def test_std(self):
        ...
        # ground truth
        f_std_gt = [15.72135120308624, 0.09255279797193551, 0.15, 11.340113304616798, 0.0529001056654038, 0.466681022626497,
                    -0.02037000180254231, -1072.4665253469798, -253.94486828306555]
        # test
